...
//
//*****************************************************************************
#define SYSCLOCK_RATE_HZ        120000000
...
//
// CS settings - PP5 NOW PB4
//
#define SPI_CS_PORT                 GPIO_PORTB_BASE
#define SYSCTL_PERIPH_SPI_PORT      SYSCTL_PERIPH_GPIOB
#define SYSCTL_PERIPH_SPI2_PORT		SYSCTL_PERIPH_GPIOB
...
#define SYSCTL_PERIPH_SPI           SYSCTL_PERIPH_SSI1
#define SYSCTL_PERIPH_SPI_BASE      SYSCTL_PERIPH_GPIOE
#define SYSCTL_PERIPH_SPI2_BASE		SYSCTL_PERIPH_GPIOB
#define SPI_PORT                    GPIO_PORTE_BASE
#define SPI2_PORT					GPIO_PORTB_BASE
#define SPI_CLK_PIN                 GPIO_PIN_5
#define SPI_CLK_MUX_SEL             GPIO_PB5_SSI1CLK
#define SPI_RX_PIN                  GPIO_PIN_5
#define SPI_RX_MUX_SEL              GPIO_PE5_SSI1XDAT1
#define SPI_TX_PIN                  GPIO_PIN_4
#define SPI_TX_MUX_SEL              GPIO_PE4_SSI1XDAT0
#define SPI_UDMA_RX_CHANNEL         UDMA_CH24_SSI1RX
